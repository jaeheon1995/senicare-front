...
export default function Auth() {
    ...
    const onPasswordChangeHandler = (event: ChangeEvent<HTMLInputElement>) => {
        ...
        const isEquel = passwordCheck===value;
        const checkMessage = isEquel ? '' : '비밀번호가 일치하지 않습니다.';
        setPasswordCheckMessage(checkMessage);
        setPasswordCheckMessageError(!isEquel);
    };
    ...
    const onPasswordCheckChangeHandler = (event: ChangeEvent<HTMLInputElement>) => {
        ...
        const isEquel = password ===value
        const message = isEquel ?'':'비밀번호가 일치하지 않습니다'
